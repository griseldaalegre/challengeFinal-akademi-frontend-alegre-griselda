        ...
        <>
          ...
          {pages > 1 && (
            <Pagination
              totalPages={pages}
              currentPage={page}
              onPageChange={(newPage) => getGrades(studentId, newPage, getCurrentFilters())}
            />
          )}
        </>
      )}
...
export default connect(mapStateToProps, mapDispatchToProps)(GradesStudentPage);
